...
# Llamita Local Installation Script
# This script installs everything needed to run Llamita
# Download this script and run it locally to avoid GitHub rate limiting

set -e  # Exit on any error

echo "🦙 Llamita Local Installation Script"
echo "===================================="
echo ""
